...
const baseNftStay: object = { creator: '', id: 0, sID: '', owner: '', name: '', description: '', image: '', tokenUri: '' }

export const NftStay = {
  encode(message: NftStay, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): NftStay {
    ...
    const message = { ...baseNftStay } as NftStay
