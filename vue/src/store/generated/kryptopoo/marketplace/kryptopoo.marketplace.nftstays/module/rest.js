...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryMarketAll = (query, params = {}) => this.request({
         ...
         */
        this.queryMarket = (id, params = {}) => this.request({
         ...
         */
        this.queryNftStayAll = (query, params = {}) => this.request({
         ...
         */
        this.queryNftStay = (id, params = {}) => this.request({
