...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.NftstaysPacketData
	...
	case *types.NftstaysPacketData_IbcTransferNftStayPacket:
		packetAck, err := am.keeper.OnRecvIbcTransferNftStayPacket(ctx, modulePacket, *packet.IbcTransferNftStayPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeIbcTransferNftStayPacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.NftstaysPacketData_IbcTransferNftStayPacket:
		err := am.keeper.OnAcknowledgementIbcTransferNftStayPacket(ctx, modulePacket, *packet.IbcTransferNftStayPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcTransferNftStayPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.NftstaysPacketData_IbcTransferNftStayPacket:
		err := am.keeper.OnTimeoutIbcTransferNftStayPacket(ctx, modulePacket, *packet.IbcTransferNftStayPacket)
		if err != nil {
			return nil, err
		}
	default:
